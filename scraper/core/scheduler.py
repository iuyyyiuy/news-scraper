...
class SchedulerService:
    ...
    def schedule_daily_scrape(self):
        ...
        """
        try:
            # TEST: Schedule for 10:58 AM HKT for immediate testing
            self.scheduler.add_job(
                func=self._run_daily_scrape,
                trigger=CronTrigger(hour=10, minute=58, timezone=pytz.timezone('Asia/Shanghai')),
                id='daily_scrape',
                name='Daily News Scraping',
                replace_existing=True
            )
            print("✅ Scheduled daily scrape at 10:58 AM HKT for testing")
